...
public class FormularioBuscarNombre extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(nombreField.equals("")){
            ...
            ArrayList<Producto> productosNombre = Archivo.getProductoPorNombre(nombreField);
            ArrayList<Producto> Ordenados = Archivo.ordenarListas(productosNombre, ordenField);
