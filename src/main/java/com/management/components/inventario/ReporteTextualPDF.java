...
public class ReporteTextualPDF {
    ...
    public ReporteTextualPDF(String id){
        ...
        try {
            ...
            Paragraph title = new Paragraph("Reporte de Desempeño del Negocio - Mes de Abril de 2023", FontFactory.getFont(FontFactory.HELVETICA_BOLD, 20));
            title.setAlignment(Paragraph.ALIGN_CENTER);
            document.add(title);


            Paragraph subtitle = new Paragraph("Este es un informe de desempeño para todos los productos del negocio en el mes de abril de 2023.", FontFactory.getFont(FontFactory.HELVETICA, 15));
            ...
            Map<String, Integer> productosVendidosMap = ArchivoInventario.getProductosMasVendidos(inventario.getRegistros());

            int contador = 0;

            for (Map.Entry<String, Integer> entry : productosVendidosMap.entrySet()) {
