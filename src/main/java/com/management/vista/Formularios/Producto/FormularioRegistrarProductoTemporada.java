...
public class FormularioRegistrarProductoTemporada extends JFrame implements ActionListener, ItemListener {
    ...
    public FormularioRegistrarProductoTemporada(){
        super("Registrar Producto por temporada");
        setLayout(new FlowLayout());

        temporada = new JComboBox<String>(temporadas);
        temporadaLabel = new JLabel("Temporada: ");
